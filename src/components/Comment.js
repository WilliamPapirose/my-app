	...
	render() {
		return(
			<div class="comment"> 
                ...
                <textarea class='comment_textarea' ref={ref => this.comment = ref} onChange={this.onChange} value={this.props.text} disabled={(this.props.author === this.props.user && this.state.can_edit) ? false : true}></textarea>
                </div>
